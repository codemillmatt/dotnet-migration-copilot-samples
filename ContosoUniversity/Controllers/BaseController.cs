...
namespace ContosoUniversity.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        {
            _ = Task.Run(async () => await SendEntityNotificationAsync(entityType, entityId, operation));
        }
        ...
        {
            _ = Task.Run(async () => await SendEntityNotificationAsync(entityType, entityId, entityDisplayName, operation));
        }
